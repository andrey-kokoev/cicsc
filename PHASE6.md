...
### TODOs
- [ ] P6.1.1 Select second reference vertical and freeze evaluation criteria artifact.
- [ ] P6.1.2 Run staged workload for second vertical with the same invariant/conformance/migration gates.
