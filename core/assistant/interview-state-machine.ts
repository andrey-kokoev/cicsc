...
export class InterviewStateMachine {
  ...
  protected detailStep: "STATES" | "ATTRIBUTES" | "COMMANDS" = "STATES"
  ...
  protected randomQuestion (step: keyof typeof QUESTION_TEMPLATES): string {
  ...
  protected parseAttributes (input: string): { name: string; type: string; optional: boolean }[] {
  ...
  protected parseCommands (input: string, entity: EntityDraft): CommandDraft[] {
