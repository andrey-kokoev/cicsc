...
### TODOs
- [ ] P10.1.1 Freeze forced-next execution scope and ownership contract.
- [ ] P10.1.2 Add Postgres HAVING harness continuity artifact and validation test.
- [ ] P10.1.3 Publish EXISTS lowering decision contract (enablement or explicit deferred policy).
